...
export const translations = {
  pt: {
    ...
    about: {
      ...
      bio1: 'Alice Stamato trabalha com cinema e publicidade na área de direção e roteiro. Sócia da',
      bio2: 'Lombada Filmes',
      bio3: ', acredita na produtora audiovisual como espaço para filmes autorais e na pluralidade de narrativas para a comunidade LGBTQIA+. Tem bastante experiência na área, iniciou sua carreira como produtora e assistente de direção e migrando aos poucos para o roteiro e direção, assinando o roteiro de mais de seis curtas-metragens premiados em festivais nacionais e internacionais.',
      bio4: 'Em 2023, foi convidada como representante do Brasil na Mesa Redonda sobre indústria mais inclusiva e diversa no 71° Festival de San Sebastián (SSIFF). Atualmente, assina o roteiro e direção do seu primeiro longa-metragem ficcional "Ninho Tinto", produção Platô Filmes e Olhar distribuição, em fase de pós-produção, contemplado pelo FSA - Novos Realizadores 2022 e selecionado para o Fórum de Coprodução da Europa-América Latina do 71° Festival de San Sebastián (SSIFF) e para o Marché Du Film - Festival de Cannes de 2025. O filme ganhou o prêmio de finalização no WIP da Mostra Internacional de Cinema de São Paulo 2025. O roteiro de "Ninho Tinto" participou de diversos laboratórios de roteiros e mercados entre eles: II Encontro de ideias da Mostra Internacional de São Paulo, Laboratório Novas Histórias 2022, FAM Lab + ECM 2022 (contemplado pelo prêmio Paradiso), Brasil CineMundi 2022, CabíriaLab 2022 e CuritibaLab 2022.',
      bio5: 'Assume também a direção dos longas-metragens "Deus nos Guie" roteiro de Thaís Olivier e produção Lombada Filmes (Selecionado para o 13º Laboratório Novas Histórias; 3º lugar no Prêmio Cabíria 2022 de longa-metragem; 2º lugar no prêmio LATINX 2022 - concurso Latino-Americano de argumento de longa-metragem; Selecionado para o Cabíria Lab 2022, categoria longa-metragem, Semifinalista do FRAPA 2023) e "Hamster" roteiro de Georgina Castro e produção Lombada Filmes ("Prêmio Cabíria de Incentivo a Roteiristas Mulheres 2017", contemplado pelo "PROAC desenvolvimento de Longas 2019" e "Prêmio de Roteiro Antônio Bivar 2020"), ambos os longas estão em fase de desenvolvimento e captação.',
      specialties: {
  ...
  en: {
    ...
    about: {
      ...
      bio1: 'Alice Stamato is a screenwriter and director. Co-founder of the audiovisual production company',
      bio2: 'Lombada Filmes',
      bio3: ', she develops projects that explore human narratives with sensitivity and cinematic depth.',
      bio4: 'With a contemporary and authorial vision, Alice works on both fiction and documentary projects, always seeking to connect stories with audiences through a striking and engaging visual language.',
      bio5: 'Her cinematic approach combines refined technique with a constant search for emotional authenticity, creating works that resonate with audiences and leave a lasting impression.',
      specialties: {
        title: 'Specialties',
  ...
  es: {
    ...
    about: {
      ...
      pronouns: 'she/her',
      location: 'São Paulo, SP, Brasil',
      bio1: 'Alice Stamato es guionista y directora. Cofundadora de la productora audiovisual',
      bio2: 'Lombada Filmes',
      bio3: ', desarrolla proyectos que exploran narrativas humanas con sensibilidad y profundidad cinematográfica.',
      bio4: 'Con una visión contemporánea y autoral, Alice trabaja tanto en proyectos de ficción como documental, siempre buscando conectar historias con audiencias a través de un lenguaje visual impactante y envolvente.',
      bio5: 'Su enfoque cinematográfico combina técnica refinada con una búsqueda constante de autenticidad emocional, creando obras que resuenan con el público y dejan una impresión duradera.',
      specialties: {
        title: 'Especialidades',
